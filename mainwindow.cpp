...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent)
{
    ...
    sound = new QSound(":/sound/Sun.wav");
    sound->setLoops(QSound::Infinite);
    timer = new QTimer;
    scene = new QGraphicsScene(this);

/*
    scenestart = new QGraphicsScene(this);
    scenestart->setSceneRect(150, 0, 900, 600);
    scenestart->setItemIndexMethod(QGraphicsScene::NoIndex);
    viewstart = new QGraphicsView(scenestart, this);
    viewstart->resize(902, 602);
    viewstart->setRenderHint(QPainter::Antialiasing);
    viewstart->setBackgroundBrush(QPixmap(":/images/Title.jpg"));
    viewstart->setCacheMode(QGraphicsView::CacheBackground);
    viewstart->setViewportUpdateMode(QGraphicsView::BoundingRectViewportUpdate);
    viewstart->show();
*/
    ...
    view->setBackgroundBrush(QPixmap(":/images/Background2.jpg"));
